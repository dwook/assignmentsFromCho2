...
const boxAge = document.getElementsByClassName("box_age")[0];
...
const valAge = document.querySelector("#age");
const valChildbirthAge = document.querySelector("#childbirthAge");
...
function checkNumber(event){
    ...
    msg = this.nextElementSibling.nextElementSibling;
...
function goResultPage() {
    ...
    scoreTotal.innerText = test.score;
